...
Future<Hotel> fetchHotel(String city) async {
  ...
  final response = await http.get(Uri.parse(url), headers: {
    "Authorization":
        "JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2NDEzMjQ2MjIsImlhdCI6MTY0MTMyMjgyMiwibmJmIjoxNjQxMzIyODIyLCJpZGVudGl0eSI6MTA1Nn0.FGBLwkD-PFYZ9tTK29GhoMzqr00danl4U-HzHMNdaCU"
  });

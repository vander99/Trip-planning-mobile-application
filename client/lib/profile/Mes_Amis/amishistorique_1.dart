...
class AmisHistorique extends StatefulWidget {
  static String route = "amishistorique_1";

  @override
  _AmisHistorique createState() => _AmisHistorique();
}

class _AmisHistorique extends State<AmisHistorique> {
    ...
    return FutureBuilder<DocumentSnapshot>(
        ...
        builder:
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return Scaffold(
              appBar: MyAppBar(text: "Historique"),
              body: ListView(
                padding: EdgeInsets.all(16),
                children: [
